...
>
  <div
    ...
    class={classNames(
      ...
      primaryBackground ? 'bg-white dark:bg-black' : 'bg-dark-1 dark:bg-light',
    )}
  ></div>
  <svg
    aria-hidden="true"
    class={primaryBackground ? 'fill-white dark:fill-black text-primary' : 'fill-dark-1 text-white dark:fill-light dark:text-dark-2'}
    width="80"
    height="80"
    viewBox="0 0 250 250"
  >
    <path class="octo-background group-hover/github-corner:opacity-75" d="M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z"></path>
    <path class="octo-arm origin-[130px_106px] group-hover/github-corner:animate-octocat-wave group-focus/github-corner:animate-octocat-wave" fill="currentColor" d="M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2"></path>
