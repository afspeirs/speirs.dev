...
>
  <div
    ...
    class={classNames(
      ...
      primaryBackground ? 'bg-white' : 'bg-dark-1 dark:bg-white',
    )}
  ></div>
  <svg
    aria-hidden="true"
    class={primaryBackground ? 'fill-white text-primary' : 'fill-dark-1 text-white dark:fill-white dark:text-dark-2'}
    width="80"
    height="80"
    viewBox="0 0 250 250"
  >
